...
class APIPieConfig:
    base_url: str = 'https://apipie.ai'
    provider_id: str = 'apipie'
    timeout: int = 100
...
class APIClient:
    def __init__(self, config: APIPieConfig):
        self.config = config
